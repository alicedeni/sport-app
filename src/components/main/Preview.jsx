...
const Preview = () => {
  ...
  const initialActivityData = state.activityData
  const [activityData, setActivityData] = useState(initialActivityData)
  const navigate = useNavigate()
  const [user, setUser] = useState({})
  const [isPublishing, setIsPublishing] = useState(false)
  const images = activityData?.images && activityData.images.length > 0
    ? activityData.images
    ...
    <div className="preview">
      ...
      <div className="post">
        ...
        <div className={`post__content`}>
          <div
            className={`post__image-container ${activityData.type} ${!hasImages ? 'no_img' : ''}`}
            ...
            {hasImages ? (
              ...
              >
                ...
                {isHovered && (
                  ...
                  >
                    <img
                      src="https://storage.yandexcloud.net/team2go/users/base/zoomDefault.svg"
                      alt="Zoom"
                    />
                  </div>
                )}
          ...
          <div className="post__info" ref={infoContainerRef}>
            <div className="post__title">
              ...
              <div className="post__title-fire">
                <div>
                  <div className="post__title-fire-count">{activityData.activity_points}</div>
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
            ...
            <div className="post__points">
              {activityData && activityData.startDate && activityData.startTime && (
                <div className="post__points__point">
                  Дата
                  <div className={`post__metric`}>
                    {format(
                      new Date(`${activityData.startDate}T${activityData.startTime}:00`),
                      'd MMM, HH:mm',
                      { locale: ru },
                    )}
                  </div>
